...
def banner():
    ...
    runntxt(WW+"   ..................  TERMUX BY RAKIB")
    runntxt(WW+"     ....       HACKER BY RAKIB")
    runntxt(GL+"                   TERMUX KING RAKIB")
    runntxt(GG+"     ..........    DJ.RAKIB.420")
    runntxt(Y+"    ............       It's RAKIB-OK")
    runntxt(GG+"           HR-KING ")
    time.sleep(1.5)
    print GG+"  √=============================================√"
    ...
    print GL+"  |       DHANBARI, TANGAIL, DHAKA, BANGLADESH    |"
    print WW+"  |        TEAM : DJ-420-VOICE&HACKER-BOX       |"
    print Y+"  |             YOUTUBE : DJ-RAKIB-MIX-MASTER          |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ H.R ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
...
print wd+"         Termux Hacker By Rakib"
        ...
        -o:  -.......        ..       `:o-
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
             ...
             Powered by:\033[97m Hacker Rakib
      """
